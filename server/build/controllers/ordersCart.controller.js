...
exports.paymentConfirm = exports.getAllOrdersByAdmin = exports.deleteOrderById = exports.updateOrder = exports.getAllOrdersByUser = exports.createOrder = void 0;
...
const updateOrder = (req = express_1.request, res = express_1.response) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const { price, quantity, paid, ProductId } = req.body;
    try {
...
const paymentConfirm = (req = express_1.request, res = express_1.response) => __awaiter(void 0, void 0, void 0, function* () {
    const { UserId } = req.body;
    try {
...
exports.paymentConfirm = paymentConfirm;
